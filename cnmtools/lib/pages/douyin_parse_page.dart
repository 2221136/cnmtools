...
class DouyinParsePage extends StatefulWidget {
  const DouyinParsePage({super.key});

  @override
  State<DouyinParsePage> createState() => _DouyinParsePageState();
}

class _DouyinParsePageState extends State<DouyinParsePage> {
  ...
  Future<void> _parseVideo() async {
    ...
    try {
      final result = await ApiService.parseDouyin(url);
    ...
    try {
      ...
      if (kIsWeb) {
        ...
        try {
          ...
          if (directory != null) {
            final fileName = 'douyin_${DateTime.now().millisecondsSinceEpoch}.mp4';
        ...
        child: Column(
          ...
          children: [
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.video_library, color: Colors.pink[700]),
            ...
            if (_result?.data != null) ...[
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        radius: 30,
                        backgroundImage: NetworkImage(_result!.data!.avatar),
                      ),
                      ...
                      IconButton(
                        ...
                        onPressed: () => _copyText(_result!.data!.uid, '抖音号'),
                        tooltip: '复制抖音号',
                      ),
                    ],
                  ),
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              _buildStatItem(
                                Icons.favorite,
                                _formatNumber(_result!.data!.like),
                                '点赞',
                              ),
                              _buildStatItem(
                                Icons.comment,
                                _formatNumber(_result!.data!.comment),
                                '评论',
                              ),
                              _buildStatItem(
                                Icons.star,
                                _formatNumber(_result!.data!.collect),
                                '收藏',
                              ),
                              _buildStatItem(
                                Icons.share,
                                _formatNumber(_result!.data!.share),
                                '分享',
                              ),
                            ],
                          ),
                          if (_result!.data!.tags.isNotEmpty) ...[
                            const SizedBox(height: 16),
                            Wrap(
                              spacing: 8,
                              runSpacing: 8,
                              children: _result!.data!.tags.map((tag) {
                                return Chip(
                                  label: Text('#$tag'),
              ...
              if (_result!.data!.music.title.isNotEmpty)
                Card(
                  elevation: 2,
                  child: Padding(
                    padding: const EdgeInsets.all(16),
                    child: Row(
                      children: [
                        CircleAvatar(
                          radius: 25,
                          backgroundImage: NetworkImage(_result!.data!.music.avatar),
                        ),
                        const SizedBox(width: 16),
                        Expanded(
                          child: Column(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    _buildInfoItem('1. 打开抖音APP，找到想要下载的视频'),
                    _buildInfoItem('2. 点击分享按钮，选择"复制链接"'),
                    _buildInfoItem('3. 返回本应用，粘贴链接'),
                    _buildInfoItem('4. 点击"开始解析"按钮'),
                    _buildInfoItem('5. 查看视频信息并下载无水印视频'),
                    const SizedBox(height: 8),
                    Text(
                      '提示：解析后的视频为无水印版本，可直接下载保存',
                      style: TextStyle(
                        fontSize: 12,
